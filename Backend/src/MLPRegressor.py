...
df_timeseries = pd.read_csv("D:/Downloads/DREAM4 in-silico challenge/Size 10/DREAM4 training data/insilico_size10_1/insilico_size10_1_timeseries.tsv", sep = "\t", )

df_wildtype = pd.read_csv("D:/Downloads/DREAM4 in-silico challenge/Size 10/DREAM4 training data/insilico_size10_1/insilico_size10_1_wildtype.tsv", sep = "\t", )
